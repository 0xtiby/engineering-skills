...
If any of the three is missing, skip the ADR. Use the format in [ADR-FORMAT.md](./ADR-FORMAT.md). New ADRs go to `docs/adr/NNNN-<kebab-title>.md` where `NNNN` is the next sequential number.
