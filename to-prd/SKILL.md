...
1. Explore the repo to understand the current state of the codebase, if you haven't already. Use `CONTEXT.md` vocabulary throughout the PRD. Respect ADRs in the area you're touching.
